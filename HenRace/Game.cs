...
namespace HenRace
{
    public partial class Game : Form
    {
        ...
        {
            if (lakshayRadioButton.Checked)
            {
                if (puntersArray[0].PlaceBet((int)numericUpDown1.Value, (int)numericUpDown2.Value))
                {
                    lakshayBetLabel.Text = puntersArray[0].henBet.GetTheDescription();
                }
            }
        ...
        {
            lakshayRadioButton.Checked = true;
            ...
            puntersArray[0] = new HenClients()
            {
                ...
                henBet = null,
                Cashes = 50,
                MyRadioButton = lakshayRadioButton,
                MyLabel = lakshayBetLabel
            };
